...
public class AutoValueGsonExtensionTest {
  ...
  public void simple() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", "package test;\n"
        ...
        + "        int__adapter = gson.getAdapter(Integer.class);\n"
        + "      }\n"
        ...
        + "          immutableMap__string_number_adapter = (TypeAdapter<ImmutableMap<String, Number>>) gson.getAdapter(TypeToken.getParameterized(ImmutableMap.class, String.class, Number.class));\n"
        + "        }\n"
        ...
        + "          map__string_set__string_adapter = (TypeAdapter<Map<String, Set<String>>>) gson.getAdapter(TypeToken.getParameterized(Map.class, String.class, TypeToken.getParameterized(Set.class, String.class).getType()));\n"
        + "        }\n"
        ...
        + "          list__string_adapter = (TypeAdapter<List<String>>) gson.getAdapter(TypeToken.getParameterized(List.class, String.class));\n"
        + "        }\n"
        ...
        + "      } else {\n"
        + "        if (string_adapter == null) {\n"
        + "          string_adapter = new Test.TestTypeAdapter();\n"
        + "        }\n"
        ...
        + "      } else {\n"
        + "        if (list__string_adapter == null) {\n"
        + "          list__string_adapter = new Test.TestListTypeAdapter();\n"
        + "        }\n"
        ...
        + "      } else {\n"
        + "        if (string_adapter == null) {\n"
        + "          string_adapter = new Test.TestTypeAdapterFactory().create(gson, TypeToken.get(String.class));\n"
        + "        }\n"
        ...
        + "      } else {\n"
        + "        if (list__string_adapter == null) {\n"
        + "          list__string_adapter = (TypeAdapter<List<String>>) new Test.TestTypeAdapterFactory().create(gson, TypeToken.getParameterized(List.class, String.class));\n"
        + "        }\n"
  ...
  @Test public void generatesCorrectDefaultCharPrimitiveValue() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", "package test;\n"
        ...
        + "        char__adapter = gson.getAdapter(Character.class);\n"
        + "      }"
  ...
  @Test public void handlesGenericTypes() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test.AutoValue_Test", "package test;\n"
        ...
        + "      } else {\n"
        + "        if (C_adapter == null) {\n"
        + "          C_adapter = (TypeAdapter<C>) gson.getAdapter(TypeToken.get(typeArgs[2]));\n"
        + "        }\n"
        ...
        + "      } else {\n"
        + "        if (A_adapter == null) {\n"
        + "          A_adapter = (TypeAdapter<A>) gson.getAdapter(TypeToken.get(typeArgs[0]));\n"
        + "        }\n"
        ...
        + "      } else {\n"
        + "        if (B_adapter == null) {\n"
        + "          B_adapter = (TypeAdapter<B>) gson.getAdapter(TypeToken.get(typeArgs[1]));\n"
        + "        }\n"
        ...
        + "          list__A_adapter = (TypeAdapter<List<A>>) gson.getAdapter(TypeToken.getParameterized(List.class, typeArgs[0]));\n"
        + "        }\n"
        ...
        + "          map__string_list__C_adapter = (TypeAdapter<Map<String, List<C>>>) gson.getAdapter(TypeToken.getParameterized(Map.class, String.class, TypeToken.getParameterized(List.class, typeArgs[2]).getType()));\n"
        + "        }\n"
