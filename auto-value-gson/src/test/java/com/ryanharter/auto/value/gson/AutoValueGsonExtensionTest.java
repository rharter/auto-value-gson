...
public class AutoValueGsonExtensionTest {
  ...
  public void simple() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", "package "
        ...
        + "String>>>>>> "
        + "map__string_map__string_map__string_map__string_map__string_string_adapter = this"
        + ".map__string_map__string_map__string_map__string_map__string_string_adapter;\n"
        + "        if (map__string_map__string_map__string_map__string_map__string_string_adapter"
        + " == null) {\n"
        + "          this"
        + ".map__string_map__string_map__string_map__string_map__string_string_adapter = "
        + "map__string_map__string_map__string_map__string_map__string_string_adapter = "
        + "(TypeAdapter<Map<String, Map<String, Map<String, Map<String, Map<String, String>>>>>>)"
        + " gson.getAdapter(TypeToken.getParameterized(Map.class, String.class, TypeToken"
        + ".getParameterized(Map.class, String.class, TypeToken.getParameterized(Map.class, "
        + "String.class, TypeToken.getParameterized(Map.class, String.class, TypeToken"
        + ".getParameterized(Map.class, String.class, String.class).getType()).getType()).getType"
        + "()).getType()));\n"
        + "        }\n"
        + "        map__string_map__string_map__string_map__string_map__string_string_adapter"
        ...
        + ".map__string_map__string_map__string_map__string_map__string_string_adapter;\n"
        + "              if "
        + "(map__string_map__string_map__string_map__string_map__string_string_adapter == null) {\n"
        + "                this"
        + ".map__string_map__string_map__string_map__string_map__string_string_adapter = "
        + "map__string_map__string_map__string_map__string_map__string_string_adapter = "
        + "(TypeAdapter<Map<String, Map<String, Map<String, Map<String, Map<String, String>>>>>>)"
        ...
        + "              }\n"
        + "              o = "
        + "map__string_map__string_map__string_map__string_map__string_string_adapter.read"
        + "(jsonReader);\n"
        + "              continue;\n"
        + "            }\n"
