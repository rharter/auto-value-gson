...
public class AutoValueGsonExtensionTest {
  ...
  public void simpleWithBuilder() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "        switch (name) {\n"
        + "          case \"a\": {\n"
        + "            builder.a(aAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"b\": {\n"
        + "            builder.b(bAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"c\": {\n"
        + "            builder.c(cAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"_D\": {\n"
        + "            builder.d(dAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"e\": {\n"
        + "            builder.e(eAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"f\": {\n"
        + "            builder.f(fAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"g\": {\n"
        + "            builder.g(gAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"h\": {\n"
        + "            builder.h(hAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"_I_1\":\n"
        + "          case \"_I_2\":\n"
        + "          case \"_I\": {\n"
        + "            builder.i(iAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"j\": {\n"
        + "            builder.j(jAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"k\": {\n"
        + "            builder.k(kAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"l\": {\n"
        + "            builder.l(lAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"m\": {\n"
        + "            builder.m(mAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"n\": {\n"
        + "            builder.n(nAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"o\": {\n"
        + "            builder.o(oAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          default: {\n"
        + "            jsonReader.skipValue();\n"
  ...
  public void simpleWithDefaultBuilder() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
        ...
        + "@GsonTypeAdapter(TestTypeAdapterFactory.class) public abstract List<String> n();\n"
        // Default builder
        + "@AutoValueGsonBuilder public static Test.Builder builder() { return new AutoValue_Test.Builder(); }\n"
        // Deeply nested parameterized type
        + "public abstract Map<String, Map<String, Map<String, Map<String, Map<String, String>>>>> o();\n" +
        "  @AutoValue.Builder public static abstract class Builder {\n" +
        "    public abstract Builder a(String a);\n" +
  ...
  @Test public void emitsErrorForMultipleAnnotatedBuilders() {
    JavaFileObject source1 = JavaFileObjects.forSourceString("test.Foo", ""
        + "package test;\n"
        + "import com.google.auto.value.AutoValue;\n"
        + "import com.google.gson.Gson;\n"
        ...
        + "  public abstract String a();\n"
        + "  public abstract boolean b();\n"
        + "  @AutoValueGsonBuilder public static Builder builder() { return new AutoValue_Foo.Builder(); };\n"
        + "  @AutoValueGsonBuilder public static Builder builder2() { return new AutoValue_Foo.Builder(); };\n"
        + "  @AutoValue.Builder public interface Builder {\n"
        + "    Builder a(String a);\n"
        + "    Builder b(boolean b);\n"
        + "    Foo build();\n"
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoValueProcessor())
        .failsToCompile()
        .withErrorContaining("Found more than one method annotated with @AutoValueGsonBuilder in test.Foo.");
  }

  @Test public void emitsErrorForMultipleBuilders() {
    JavaFileObject source1 = JavaFileObjects.forSourceString("test.Foo", ""
        + "package test;\n"
        + "import com.google.auto.value.AutoValue;\n"
        + "import com.google.gson.Gson;\n"
        ...
        + "  public abstract String a();\n"
        + "  public abstract boolean b();\n"
        + "  public static Builder builder() { return new AutoValue_Foo.Builder(); };\n"
        + "  public static Builder builder2() { return new AutoValue_Foo.Builder(); };\n"
        + "  @AutoValue.Builder public interface Builder {\n"
        + "    Builder a(String a);\n"
        + "    Builder b(boolean b);\n"
        + "    Foo build();\n"
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoValueProcessor())
        .failsToCompile()
        .withErrorContaining("Default builder could not be inferred from test.Foo. If there is more than one non-private, static, zero arg methods returning the @AutoValue.Builder annotated type, indicate which method AutoValueGson should use with @AutoValueGsonBuilder");
  }
  ...
  @Test public void emitsErrorAnnotationWithMissingBuilder() {
    JavaFileObject source1 = JavaFileObjects.forSourceString("test.Foo", ""
        ...
        + "  public abstract String a();\n"
        + "  public abstract boolean b();\n"
        + "  @AutoValueGsonBuilder public static String builder() { return null; };\n"
        + "  public static TypeAdapter<Foo> typeAdapter(Gson gson) {\n"
        + "    return new AutoValue_Foo.GsonTypeAdapter(gson);\n"
        + "  }\n"
        + "}"
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoValueProcessor())
        .failsToCompile()
        .withErrorContaining("test.Foo does not have an @AutoValue.Builder annotated builder, but found @AutoValueGsonBuilder annotated method <builder>");
  }

  @Test public void emitsErrorInvalidDefaultBuilder() {
    JavaFileObject source1 = JavaFileObjects.forSourceString("test.Foo", ""
        + "package test;\n"
        + "import com.google.auto.value.AutoValue;\n"
        + "import com.google.gson.Gson;\n"
        ...
        + "  public abstract String a();\n"
        + "  public abstract boolean b();\n"
        + "  @AutoValueGsonBuilder public static Builder builder(String s) { return new AutoValue_Foo.Builder(); };\n"
        + "  @AutoValue.Builder public interface Builder {\n"
        + "    Builder a(String a);\n"
        + "    Builder b(boolean b);\n"
        + "    Foo build();\n"
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoValueProcessor())
        .failsToCompile()
        .withErrorContaining("Found invalid @AutoValudGsonBuilder usage in test.Foo. @AutoValueGsonBuilder may only be applied to a single non-private, static method with no args that return the @AutoValue.Builder annotated type.");
  }
  ...
  @Test public void emitsErrorForAmbiguousBuildMethod() {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoValueProcessor())
        .failsToCompile()
        .withErrorContaining("Could not determine the build method in test.Foo.Builder. If there is more than one non-private, non-static, zero arg method returning test.Foo, annotate the build method to use with @AutoValueGsonBuild.");
  }
  ...
  @Test public void emitsErrorForMultipleBuildMethods() {
    JavaFileObject source1 = JavaFileObjects.forSourceString("test.Foo", ""
        ...
        + "  @AutoValue.Builder public interface Builder {\n"
        + "    Builder a(String a);\n"
        + "    @AutoValueGsonBuild Foo sillyBuild();\n"
        + "    @AutoValueGsonBuild Foo sillierBuild();\n"
        + "  }\n"
        + "  public static TypeAdapter<Foo> typeAdapter(Gson gson) {\n"
        + "    return new AutoValue_Foo.GsonTypeAdapter(gson);\n"
        + "  }\n"
  ...
  @Test public void compilesWithMultipleBuildMethods() {
    JavaFileObject source1 = JavaFileObjects.forSourceString("test.Foo", ""
        + "package test;\n"
        + "import com.google.auto.value.AutoValue;\n"
        + "import com.google.gson.Gson;\n"
        ...
        + "    @AutoValueGsonBuild Foo build() { return autoBuild(); };\n"
        + "  }\n"
        + "  public static TypeAdapter<Foo> typeAdapter(Gson gson) {\n"
        + "    return new AutoValue_Foo.GsonTypeAdapter(gson);\n"
        + "  }\n"
