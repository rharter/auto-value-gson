...
public class AutoValueGsonExtensionTest {
  ...
  public void simple() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "    private final TypeAdapter<String> pAdapter;\n"
        + "    private final TypeAdapter<String> qAdapter;\n"
        + "    private final TypeAdapter<Integer> rAdapter;\n"
        + "    private final TypeAdapter<Long> sAdapter;\n"
        + "    private final TypeAdapter<Double> tAdapter;\n"
        ...
        + ").getType()).getType()));\n"
        + "      this.pAdapter = gson.getAdapter(String.class);\n"
        + "      this.qAdapter = gson.getAdapter(String.class);\n"
        + "      this.rAdapter = gson.getAdapter(Integer.class);\n"
        + "      this.sAdapter = gson.getAdapter(Long.class);\n"
        + "      this.tAdapter = gson.getAdapter(Double.class);\n"
        + "    }\n"
        + "    @Override\n"
        ...
        + "      jsonWriter.name(\"p\");\n"
        + "      pAdapter.write(jsonWriter, object.p().orNull());\n"
        + "      jsonWriter.name(\"q\");\n"
        + "      qAdapter.write(jsonWriter, object.q().orElse(null));\n"
        + "      jsonWriter.name(\"r\");\n"
        + "      rAdapter.write(jsonWriter, object.r().orElse(0));\n"
        + "      jsonWriter.name(\"s\");\n"
        + "      sAdapter.write(jsonWriter, object.s().orElse(0l));\n"
        + "      jsonWriter.name(\"t\");\n"
        + "      tAdapter.write(jsonWriter, object.t().orElse(0d));\n"
        ...
        + "      Optional<String> p = Optional.absent();\n"
        + "      java.util.Optional<String> q = java.util.Optional.empty();\n"
        + "      OptionalInt r = OptionalInt.empty();\n"
        + "      OptionalLong s = OptionalLong.empty();\n"
        + "      OptionalDouble t = OptionalDouble.empty();\n"
        ...
        + "          }\n"
        + "          case \"p\": {\n"
        + "            p = Optional.of(pAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"q\": {\n"
        + "            q = java.util.Optional.of(qAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"r\": {\n"
        + "            r = OptionalInt.of(rAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"s\": {\n"
        + "            s = OptionalLong.of(sAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"t\": {\n"
        + "            t = OptionalDouble.of(tAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          default: {\n"
