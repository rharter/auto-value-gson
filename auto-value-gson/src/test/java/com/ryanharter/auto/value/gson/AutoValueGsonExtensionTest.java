...
public class AutoValueGsonExtensionTest {
  ...
  @Test public void simpleNoEmpty() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + ")"
        + "final class AutoValue_Test extends $AutoValue_Test {\n"
        + "  AutoValue_Test(String a, int[] b, int c, String d, @Nullable String e, ImmutableMap<String, "
        + "Number> f,\n"
        + "      Set<String> g, Map<String, Set<String>> h, String i, @Nullable List<String> j, String k, "
        + "List<String> l,\n"
  ...
  @Test public void simpleWithJavaOptional() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
        + "package test;\n"
        + "import com.google.gson.annotations.SerializedName;\n"
        + "import com.ryanharter.auto.value.gson.GsonTypeAdapter;\n"
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "      @Nullable Optional<String> e, Optional<ImmutableMap<String, Number>> f, Optional<Set<String>> g,\n"
        + "      Optional<Map<String, Set<String>>> h, Optional<String> i, @Nullable Optional<List<String>> j,\n"
        + "      Optional<String> k, Optional<List<String>> l, Optional<String> m, Optional<List<String>> n,\n"
        ...
        + "    private final TypeAdapter<Map<String, Map<String, Map<String, Map<String, "
        + "Map<String, String>>>>>> oAdapter;\n"
        + "    private final TypeAdapter<Integer> pAdapter;\n"
        + "    private final TypeAdapter<Long> qAdapter;\n"
        + "    private final TypeAdapter<Double> rAdapter;\n"
        + "    public GsonTypeAdapter(Gson gson) {\n"
        + "      this.aAdapter = gson.getAdapter(String.class);\n"
        + "      this.bAdapter = gson.getAdapter(int[].class);\n"
        + "      this.cAdapter = gson.getAdapter(Integer.class);\n"
        ...
        + "TypeToken.getParameterized(Map.class, String.class, String.class).getType()).getType()"
        + ").getType()).getType()));\n"
        + "      this.pAdapter = gson.getAdapter(Integer.class);\n"
        + "      this.qAdapter = gson.getAdapter(Long.class);\n"
        + "      this.rAdapter = gson.getAdapter(Double.class);\n"
        + "    }\n"
        + "    @Override\n"
        + "    public void write(JsonWriter jsonWriter, Test object) throws IOException {\n"
        + "      if (object == null) {\n"
        ...
        + "      jsonWriter.beginObject();\n"
        + "      jsonWriter.name(\"a\");\n"
        + "      aAdapter.write(jsonWriter, object.a().orElse(null));\n"
        + "      jsonWriter.name(\"b\");\n"
        + "      bAdapter.write(jsonWriter, object.b().orElse(null));\n"
        + "      jsonWriter.name(\"c\");\n"
        + "      cAdapter.write(jsonWriter, object.c().orElse(null));\n"
        + "      jsonWriter.name(\"_D\");\n"
        + "      dAdapter.write(jsonWriter, object.d().orElse(null));\n"
        + "      jsonWriter.name(\"e\");\n"
        + "      eAdapter.write(jsonWriter, object.e().orElse(null));\n"
        + "      jsonWriter.name(\"f\");\n"
        + "      fAdapter.write(jsonWriter, object.f().orElse(null));\n"
        + "      jsonWriter.name(\"g\");\n"
        + "      gAdapter.write(jsonWriter, object.g().orElse(null));\n"
        + "      jsonWriter.name(\"h\");\n"
        + "      hAdapter.write(jsonWriter, object.h().orElse(null));\n"
        + "      jsonWriter.name(\"_I\");\n"
        + "      iAdapter.write(jsonWriter, object.i().orElse(null));\n"
        + "      jsonWriter.name(\"j\");\n"
        + "      jAdapter.write(jsonWriter, object.j().orElse(null));\n"
        + "      jsonWriter.name(\"k\");\n"
        + "      kAdapter.write(jsonWriter, object.k().orElse(null));\n"
        + "      jsonWriter.name(\"l\");\n"
        + "      lAdapter.write(jsonWriter, object.l().orElse(null));\n"
        + "      jsonWriter.name(\"m\");\n"
        + "      mAdapter.write(jsonWriter, object.m().orElse(null));\n"
        + "      jsonWriter.name(\"n\");\n"
        + "      nAdapter.write(jsonWriter, object.n().orElse(null));\n"
        + "      jsonWriter.name(\"o\");\n"
        + "      oAdapter.write(jsonWriter, object.o().orElse(null));\n"
        + "      jsonWriter.name(\"p\");\n"
        + "      pAdapter.write(jsonWriter, object.p().orElse(0));\n"
        + "      jsonWriter.name(\"q\");\n"
        + "      qAdapter.write(jsonWriter, object.q().orElse(0l));\n"
        + "      jsonWriter.name(\"r\");\n"
        + "      rAdapter.write(jsonWriter, object.r().orElse(0d));\n"
        + "      jsonWriter.endObject();\n"
        + "    }\n"
        + "    @Override\n"
        + "    public Test read(JsonReader jsonReader) throws IOException {\n"
        ...
        + "        switch (_name) {\n"
        + "          case \"a\": {\n"
        + "            a = Optional.of(aAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"b\": {\n"
        + "            b = Optional.of(bAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"c\": {\n"
        + "            c = Optional.of(cAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"_D\": {\n"
        + "            d = Optional.of(dAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"e\": {\n"
        + "            e = Optional.of(eAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"f\": {\n"
        + "            f = Optional.of(fAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"g\": {\n"
        + "            g = Optional.of(gAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"h\": {\n"
        + "            h = Optional.of(hAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"_I_1\":\n"
        + "          case \"_I_2\":\n"
        + "          case \"_I\": {\n"
        + "            i = Optional.of(iAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"j\": {\n"
        + "            j = Optional.of(jAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"k\": {\n"
        + "            k = Optional.of(kAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"l\": {\n"
        + "            l = Optional.of(lAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"m\": {\n"
        + "            m = Optional.of(mAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"n\": {\n"
        + "            n = Optional.of(nAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"o\": {\n"
        + "            o = Optional.of(oAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"p\": {\n"
        + "            p = OptionalInt.of(pAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"q\": {\n"
        + "            q = OptionalLong.of(qAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"r\": {\n"
        + "            r = OptionalDouble.of(rAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          default: {\n"
        + "            jsonReader.skipValue();\n"
  ...
  @Test public void simpleWithJavaOptionalAndDefaults() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
        + "package test;\n"
        + "import com.google.gson.annotations.SerializedName;\n"
        + "import com.ryanharter.auto.value.gson.GsonTypeAdapter;\n"
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "      Optional<Map<String, Set<String>>> h, Optional<String> i, @Nullable Optional<List<String>> j,\n"
        + "      Optional<String> k, Optional<List<String>> l, Optional<String> m, Optional<List<String>> n,\n"
        + "      OptionalInt o, OptionalLong p, OptionalDouble q, Optional<String> r) {\n"
        + "    super(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r);\n"
        + "  }\n"
        + "\n"
        + "  public static final class GsonTypeAdapter extends TypeAdapter<Test> {\n"
        ...
        + "    private final TypeAdapter<String> mAdapter;\n"
        + "    private final TypeAdapter<List<String>> nAdapter;\n"
        + "    private final TypeAdapter<Integer> oAdapter;\n"
        + "    private final TypeAdapter<Long> pAdapter;\n"
        + "    private final TypeAdapter<Double> qAdapter;\n"
        + "    private final TypeAdapter<String> rAdapter;\n"
        ...
        + "      this.nAdapter = (TypeAdapter<List<String>>) new Test.TestTypeAdapterFactory()"
        + ".create(gson, TypeToken.getParameterized(List.class, String.class));\n"
        + "      this.oAdapter = gson.getAdapter(Integer.class);\n"
        + "      this.pAdapter = gson.getAdapter(Long.class);\n"
        + "      this.qAdapter = gson.getAdapter(Double.class);\n"
        + "      this.rAdapter = gson.getAdapter(String.class);\n"
        + "    }\n"
        + "    @Override\n"
        + "    public void write(JsonWriter jsonWriter, Test object) throws IOException {\n"
        + "      if (object == null) {\n"
        ...
        + "      nAdapter.write(jsonWriter, object.n().orElse(null));\n"
        + "      jsonWriter.name(\"o\");\n"
        + "      oAdapter.write(jsonWriter, object.o().orElse(0));\n"
        + "      jsonWriter.name(\"p\");\n"
        + "      pAdapter.write(jsonWriter, object.p().orElse(0L));\n"
        + "      jsonWriter.name(\"q\");\n"
        + "      qAdapter.write(jsonWriter, object.q().orElse(0d));\n"
        + "      jsonWriter.name(\"r\");\n"
        + "      rAdapter.write(jsonWriter, object.r().orElse(null));\n"
        + "      jsonWriter.endObject();\n"
        + "    }\n"
        + "    @Override\n"
        + "    public Test read(JsonReader jsonReader) throws IOException {\n"
        ...
        + "          }\n"
        + "          case \"o\": {\n"
        + "            o = OptionalInt.of(oAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"p\": {\n"
        + "            p = OptionalLong.of(pAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          case \"q\": {\n"
        + "            q = OptionalDouble.of(qAdapter.read(jsonReader));\n"
        + "            break;\n"
        + "          }\n"
        + "          default: {\n"
        + "            jsonReader.skipValue();\n"
  ...
  @Test public void simpleWithGuavaOptional() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
        + "package test;\n"
        + "import com.google.gson.annotations.SerializedName;\n"
        + "import com.ryanharter.auto.value.gson.GsonTypeAdapter;\n"
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "      jsonWriter.beginObject();\n"
        + "      jsonWriter.name(\"a\");\n"
        + "      aAdapter.write(jsonWriter, object.a().orNull());\n"
        + "      jsonWriter.name(\"b\");\n"
        + "      bAdapter.write(jsonWriter, object.b().orNull());\n"
        + "      jsonWriter.name(\"c\");\n"
        + "      cAdapter.write(jsonWriter, object.c().orNull());\n"
        + "      jsonWriter.name(\"_D\");\n"
        + "      dAdapter.write(jsonWriter, object.d().orNull());\n"
        + "      jsonWriter.name(\"e\");\n"
        + "      eAdapter.write(jsonWriter, object.e().orNull());\n"
        + "      jsonWriter.name(\"f\");\n"
        + "      fAdapter.write(jsonWriter, object.f().orNull());\n"
        + "      jsonWriter.name(\"g\");\n"
        + "      gAdapter.write(jsonWriter, object.g().orNull());\n"
        + "      jsonWriter.name(\"h\");\n"
        + "      hAdapter.write(jsonWriter, object.h().orNull());\n"
        + "      jsonWriter.name(\"_I\");\n"
        + "      iAdapter.write(jsonWriter, object.i().orNull());\n"
        + "      jsonWriter.name(\"j\");\n"
        + "      jAdapter.write(jsonWriter, object.j().orNull());\n"
        + "      jsonWriter.name(\"k\");\n"
        + "      kAdapter.write(jsonWriter, object.k().orNull());\n"
        + "      jsonWriter.name(\"l\");\n"
        + "      lAdapter.write(jsonWriter, object.l().orNull());\n"
        + "      jsonWriter.name(\"m\");\n"
        + "      mAdapter.write(jsonWriter, object.m().orNull());\n"
        + "      jsonWriter.name(\"n\");\n"
        + "      nAdapter.write(jsonWriter, object.n().orNull());\n"
        + "      jsonWriter.name(\"o\");\n"
        + "      oAdapter.write(jsonWriter, object.o().orNull());\n"
        + "      jsonWriter.endObject();\n"
        + "    }\n"
        + "    @Override\n"
        + "    public Test read(JsonReader jsonReader) throws IOException {\n"
  ...
  @Test public void simpleWithGuavaOptionalAndDefaults() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
        + "package test;\n"
        + "import com.google.gson.annotations.SerializedName;\n"
        + "import com.ryanharter.auto.value.gson.GsonTypeAdapter;\n"
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "    private final TypeAdapter<String> mAdapter;\n"
        + "    private final TypeAdapter<List<String>> nAdapter;\n"
        + "    private final TypeAdapter<String> oAdapter;\n"
        ...
        + "      this.nAdapter = (TypeAdapter<List<String>>) new Test.TestTypeAdapterFactory()"
        + ".create(gson, TypeToken.getParameterized(List.class, String.class));\n"
        + "      this.oAdapter = gson.getAdapter(String.class);\n"
        + "    }\n"
        + "    @Override\n"
        + "    public void write(JsonWriter jsonWriter, Test object) throws IOException {\n"
        + "      if (object == null) {\n"
