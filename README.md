...
There is an annotation in the `auto-value-gson` artifact called `@GenerateTypeAdapter`. This annotation
...
compile 'com.ryanharter.auto.value:auto-value-gson:0.8.0'
```
