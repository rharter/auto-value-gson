...
enable this via `autovaluemoshi.useFieldNamePolicy` processor option. This acts as a flag (any value is ignored)
...
tasks.withType(JavaCompile) {
    options.compilerArgs += "-Aautovaluemoshi.useFieldNamePolicy"
}
```
